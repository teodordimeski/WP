...
public class ItemsPage extends AbstractPage {
    ...
    public ItemsPage filter(String name, String areaSize, String rating, String parkType, String location) {
        System.out.println(driver.getCurrentUrl());
        this.name.sendKeys(name);
        this.areaSize.sendKeys(areaSize);
        this.rating.sendKeys(rating);

        Select selectParkType = new Select(this.parkType);
        ...
        String url = "?name=" + name + "&areaSize=" + areaSize + "&rating=" + rating + "&parkType=" + parkType + "&locationId=" + location;
        if (driver.getCurrentUrl().contains("/national-parks")) {
            url = "/national-parks" + url;
        } else {
            url = "/" + url;
        }
